...
var game = new Phaser.Game(800, 600, Phaser.CANVAS, 'preload', { preload: preload, create: create, render: render });
function preload() {
    ...
    game.load.video('chrome', 'crome.webm');
...
function create() {
    ...
    sprite = video.addToWorld(game.world.centerX, game.world.centerY, 0.5, 0.5, 1.25, 2);
